    ...
    <div class="top-header-content">
      ...
      <div class="breadcrumb-contentnhy">
        <div class="container">          <nav aria-label="breadcrumb">
            <h2 class="hny-title text-center"> Sell Options </h2>
...
<section class="w3l-footer-22">
   ...
   <script>
    ...
    <?php
        $TshirtCatagory = $_COOKIE["TshirtCatagory"];
        $TshirtType = $_COOKIE["TshirtType"];
        $FolderName = "MaleProductForSell";
        
        if($TshirtType == "all")
        {
            echo "console.log('".$TshirtCatagory."','".$TshirtType."');";
            if($TshirtCatagory == "Male")
            {
                $query = "select * from maleproductsforsale ;";
                $FolderName = "MaleProductForSell";
            }
            else if($TshirtCatagory == "Female")
            {
                $query = "select * from femaleproductsforsale ;";
                $FolderName = "FemaleProductForSell";
            }
        }
        else
        {
            if($TshirtCatagory == "Male")
            {
                $query = "select * from maleproductsforsale where 'Tshirt-Type' = '".$TshirtType."';";
                $FolderName = "MaleProductForSell";
            }
            else if($TshirtCatagory == "Female")
            {
                $query = "select * from femaleproductsforsale  where 'Tshirt-Type' = '".$TshirtType."';;";
                $FolderName = "FemaleProductForSell";
            }
        }
        ...
        while($row = $result->fetch_assoc())
        {
            ...
            $i += 1;
            echo"CartDiv.innerHTML +=\"<div class='Items' id='cart".$i."' onclick='RefranceToSellPage(".$row['S_NO'].",`".$row['ProductName']."`,`".$row['ProductDetails']."`,`".$row['Price']."`,`".$row['UserID']."`,`".$row['Tshirt-Type']."`,`".$FolderName."`,`".$row['DesigneUsed']."` )'></div>\";";
            ...
            echo"ItemImage.innerHTML +=\"<img src='".$FolderName."/".$row['S_NO'].".jpeg' width='100%' height='100%'>\";";
            ...
            echo"ItemPrice.innerHTML += \"<p>Rs. ".$row['Price']."<p>\";";
        }
    ?>

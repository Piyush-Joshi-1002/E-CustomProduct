...
<head>
  ...
  <link href="assets/css/ForSellProductOnly.css" rel="stylesheet">
  <script src="assets/js/html2canvas.js"></script>
  <script src="assets/js/Control.js" type="text/javascript"></script>
  <script src="assets/js/Buyproduct.js" type="text/javascript"></script>
            ...
            <ul class="top-hnt-right-content col-lg-6">
                  ...
                  <li class="" id="userName">
                    ...
                    <li class="transmitvcart galssescart2 cart cart box_1">
                        <form action="#" method="post" class="last">
                          <input type="hidden" name="cmd" value="_cart">
                            <button class="top_transmitv_cart" type="button" onclick="ChqSignIN(4)" name="submit" value="">
                                My Order
                                <span class="fa fa-shopping-cart"></span>
                            </button>
                        </form>
            ...
            <div class="overlay-login text-left" id="wrap">
                ...
                <div class="wrap">
                    ...
                    <div id="login_Signup" class="login-bghny p-md-5 p-4 mx-auto mw-100">
                        ...
                        <form action="SellPage.php" id="SignInAccount" method="post">
                        ...
                        <form action="SellPage.php" Id="CreateAccount" method="post">
                            <div class="form-group">
...
<section id="User_Product ">
    <div id="Product_Details">    
        <div class="Product_Image">
            <img id="Product_Image" src="uploads/68.jpeg" width="100%" height="100%">
        </div>
        <div class="Detail">
            <div id="Product_Name" class="Name" style="margin:0%"><h1>Costome Tshirt Type</h1></div>
            <div id="Product_Description" class="details"><b><i>loram lipsam lafklfka l jjlja jlkfjd oioewjf the winner and the geret person</i></b> </div>
            <div Id="BuyOption" >
                <div class="BuyOptionBody" class="details">
                   <button class="button" class="details" onclick="ChangePrice()">
                        Quantity
                        <select name="Quantity" id="Quantity"  value="Q" >
                ...
                <div id="Product_Price" class="details"><h2>Price - 300Rs</h2></div>
            </div>
            <div id="BuyOptions" class="details">
                <div class="AddToCart cartOptions" onclick = "ChqSignIN(0)">Add To Cart</div>
                <div class="BuyNow cartOptions" onclick="ChqSignIN(1)"> Buy Now</div>
            </div>
            <div class="BuyOptionBodyMobile">
                <button class="button">
                    Quantity
                    <select name="Quantity" id="Quantity"  value="Q" >
                          <option value="1">1</option>
                ...
                <div id="BuyOptionsForMobile">
                        <div class="AddToCart cartOptions">Add To Cart</div>
                        <div class="BuyNow cartOptions"> Buy Now</div>
                </div>
            </div>
        </div>
    </div>
       ...
       <div id="close" onclick="document.getElementById('AddToCartDiv').style.display = 'none';">X</div>
        <div id="centerDiv">
            ...
            <div id="centerBorderDiv">
                <form action="post">
                <input type="button" value="Cash delivery" onclick="saveDataToBuy('Cash On Delevery')"><br>
                  <a href="payment-proccess.php"><input type="button" value="Payment using UPI"></a>
                </form>
...
<script>
  $(function () {
    ...
    if(localStorage.getItem("Product_No"))
    {
        ...
        document.getElementById("Product_Image").src = ""+foldername+"/"+Product_No+".jpeg";
        document.getElementById("Product_Name").innerHTML = "<h1>"+ProductName+"</h1>";
        document.getElementById("Product_Description").innerHTML = "<b><i>"+ProductDetails+"</i></b>";
        document.getElementById("Product_Price").innerHTML = "<h2>Price - "+Price+"Rs</h2>";
    }

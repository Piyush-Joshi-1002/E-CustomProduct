...
<section id="Empty">
    <div class="innerEmpty">
        <div class="EmptyMsg"><h1>Cart is Empty</h1></div>
    </div>
</section>
...
<section class="w3l-footer-22">
      ...
      <div class="footer-hny py-5">
          <div class="container py-lg-5">
              <div class="text-txt row">
              	...
              	Crowd<span class="lohny">l</span>ine</a></h3>
                      <!-- if logo is image enable this   
                                    <a class="navbar-brand" href="#index.html">
                                        <img src="image-path" alt="Your logo" title="Your logo" style="height:35px;" />
                                    </a> -->
   ...
   <script>
    ...
    <?php
        $ID = $_COOKIE["id"];
        $query = "select * from addtocart where UserID = ".$ID.";";
        ...
        while($row = $result->fetch_assoc())
        {
            ...
            echo"ItemImage.innerHTML +=\"<img src='CartItems/".$row['S_NO'].".jpeg' width='100%' height='100%'>\";";
            ...
            echo"innerDiv.innerHTML +=\"<div class='ItemQuantity' id='ItemQuantity".$i."'><h3>Quantity</h3></div>\";";
            echo"ItemQuantity = document.getElementById('ItemQuantity".$i."');";
            echo"ItemQuantity.innerHTML += \"<p>".$row['ProductQuantity']."<p>\";\n";
            echo"ItemQuantity.innerHTML += \"<button class='BuyNow' onclick='addToBuy(".$row['S_NO'].",`".$row['ProductName']."`,`".$row['ProductPrice']."`,`".$row['ProductDetails']."`,`".$row['ProductQuantity']."`,`".$ID."`,`cart".$i."`,".$row['Artist_Id'].",`".$row['DesigneUsed']."`)' >Buy Now</button>\";";
            echo"ItemQuantity.innerHTML += \"<button class='RemoveFromCart' onclick=removeFormCart(".$row['S_NO'].",'cart".$i."') >X</button>\";\n";
        }
    ?>
// 
</script> 
...
?>
<?php
    include "assets/php/CartPagePhp.php";
?>

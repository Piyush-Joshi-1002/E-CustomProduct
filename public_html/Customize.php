   ...
   <script src="assets/js/html2canvas.js"></script>
    <script>
      function saveDataToBuy(OrderType) {
        window.scrollTo(0, 0);  
        setCookies("OrderType",OrderType,10);
       ...
       <div id="close" onclick="document.getElementById('AddToCartDiv').style.display = 'none';">X</div>
        <div id="centerDiv">
            ...
            <div id="centerBorderDiv">
                <form action="post">
                    <input type="button" value="Cash on delivery" onclick="saveDataToBuy('Cash on delivery')"><br>
    ...
    <div class="top-header-content">
            ...
            <div class="overlay-login text-left" id="wrap">
              ...
              <div class="wrap" >
							...
							<div id="login_Signup" class="login-bghny p-md-5 p-4 mx-auto mw-100">
								...
								<form action="Customize.php" id="SignInAccount" method="post">
								...
								<form action="Customize.php" Id="CreateAccount" method="post">
									<div class="form-group">
      ...
      <div class="breadcrumb-contentnhy">
        <div class="container">          <nav aria-label="breadcrumb">
            <h2 class="hny-title text-center">Customize Your T-shirt</h2>
...
<section>
    ...
    <div id = "Customize">
        <div id="left">
            <div class = "Disignes" onclick= "setMiddleValue(1)">Color and Size Controls</div>
            <div class = "Disignes" onclick= "setMiddleValue(2)">Designes</div>
            <div class = "Disignes" onclick= "setMiddleValue(3)">Upload Your Designe</div>
            <div class = "Disignes" onclick= "setMiddleValue(4)">Custome Text</div>
        </div>
        <div id="Middle">
           <div Id="DynamicAreaOfMiddle"> </div>
        ...
        <div id="Right">
            <div id="tshirt_Container_Customize">
                <img  id = "tshirt_Image_Customize" src="assets/images/male/halfSleeve/ffffff.png">
                <div id="outerDisignDiv">
                </div>
            </div>
        </div>
    </div>
     <script type="text/javascript">
        if(localStorage.getItem('TshirtSource'))
        {
            let source = localStorage.getItem('TshirtSource');
            let Type = localStorage.getItem('TshirtType');
            if(source != undefined)
                document.getElementById("tshirt_Image_Customize").src = "assets/images/"+Type+"/"+source+"/ffffff.png";
        }

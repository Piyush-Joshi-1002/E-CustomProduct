...
<head>
  ...
  <link href="assets/css/UploadImage.css" type="text/css" rel="stylesheet">
    ...
    <div class="top-header-content">
      ...
      <div class="breadcrumb-contentnhy">
        <div class="container">          <nav aria-label="breadcrumb">
            <h2 class="hny-title text-center"> My Designes </h2>
 ...
 function UploadImgae(e)
 {
     ...
     reader.onload = function(event) {
         ...
         var ajax = new XMLHttpRequest();
          ajax.open("POST", "save-UserDesigne.php", true);
          ajax.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
          ajax.send("image=" + event.target.result);
